let Koa,Router,bodyParser,mongoose,api,createFakeData;_3d0‍.w("koa",[["default",["Koa"],function(v){Koa=v}]]);_3d0‍.w("koa-router",[["default",["Router"],function(v){Router=v}]]);_3d0‍.w("koa-bodyparser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_3d0‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_3d0‍.w("./api",[["default",["api"],function(v){api=v}]]);_3d0‍.w("./createFakeData",[["default",["createFakeData"],function(v){createFakeData=v}]]);//607 .eslintrc.json 설정 하면 빨강줄 에러 사라짐
...
app.listen(port, () => {
  _3d0‍.g.console.log('Listening to port %d', port);
});
